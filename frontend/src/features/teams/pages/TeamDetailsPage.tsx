            ...
            <div className="card snapshot-card">
                <div className="card-body">
                    <div className="snapshot-header">
                        <div>
                            <div className="snapshot-scoreline">
                                <span className="snapshot-team">{teamQuery.data.team_name}</span>
                            </div>
                            <div className="snapshot-meta">
                                <span>{activeSeason}</span>
                                <span className="meta-divider">•</span>
                                <span>{teamQuery.data.country || 'Country n/a'}</span>
                                <span className="meta-divider">•</span>
                                <span>{teamAnalysisQuery.data.matches.length} matches in library</span>
                                <span className="meta-divider">•</span>
                                <span>{teamAnalysisQuery.data.analyzedMatches} matches used for aggregate analysis</span>
                            </div>
                        </div>
                    </div>
                </div>
